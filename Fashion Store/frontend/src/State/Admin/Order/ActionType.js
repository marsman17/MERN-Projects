...
export const DELIVERED_ORDER_SUCCESS = "DELIVERED _ORDER_SUCCESS";
export const DELIVERED_ORDER_FAILURE = "DELIVERED _ORDER_FAILURE";

//Action types for CANCELLED order export const
export const CANCELLED_ORDER_REQUEST = "CANCELLED _ORDER_REQUEST";
