...
export const FIND_PRODUCTS_REQUEST = "FIND_PRODUCT_BY_REQUEST_REQUEST";
export const FIND_PRODUCTS_SUCCESS = "FIND_PRODUCT_BY_REQUEST_SUCCESS";
export const FIND_PRODUCTS_FAILURE = "FIND_PRODUCT_BY_REQUEST_FAILURE";
